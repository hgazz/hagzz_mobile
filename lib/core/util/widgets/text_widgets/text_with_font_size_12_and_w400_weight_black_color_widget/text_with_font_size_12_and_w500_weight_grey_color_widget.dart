...
class TextWithFontSize12AndW400WeightBlackColorWidget extends StatelessWidget {
  final String? text;
  final bool isServer;

  const TextWithFontSize12AndW400WeightBlackColorWidget(
      {super.key, required this.text, this.isServer = false});

  const TextWithFontSize12AndW400WeightBlackColorWidget.server(
