...
class TextWithFontSize14AndWeight700WithGreyColorWidget
  ...
  const TextWithFontSize14AndWeight700WithGreyColorWidget(
      {super.key,
      required this.text,
      this.isServer = false,
      this.color,
  ...
  const TextWithFontSize14AndWeight700WithGreyColorWidget.server(
      {super.key,
      required this.text,
      this.isServer = true,
      this.color,
